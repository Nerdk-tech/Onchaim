import{cL as t,cM as e,cN as i,cO as n,cP as o,cQ as s,cR as r,cW as a,dn as l,cV as u,dP as c,cZ as h,dc as p,d6 as d,c_ as m}from"./lucifer.v8.js";const g=t`
  :host {
    position: relative;
...
`;var $,I=function(t,e,i,n){var o,s=arguments.length,r=s<3?e:n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(r=(s<3?o(r):s>3?o(e,i,r):o(e,i))||r);return s>3&&r&&Object.defineProperty(e,i,r),r};let T=$=class extends o{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=c.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=h.state.data?.email,this.authConnector=p.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=Boolean(this.timeoutTimeLeft),e=this.getFooterLabels(t);return s`
      <wui-flex
