...
`;var B=function(e,t,o,i){var n,s=arguments.length,a=s<3?t:i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(s<3?n(a):s>3?n(t,o,a):n(t,o))||a);return s>3&&a&&Object.defineProperty(t,o,a),a};let O=class extends i{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;const e=this.amount&&this.price?s.multiply(this.price,this.amount)?.toFixed(3):null;return a`
    ...
    `}visualTemplate(){return this.imageError?a`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};O.styles=[w,m,N],B([o()],O.prototype,"imageSrc",void 0),B([o()],O.prototype,"name",void 0),B([o()],O.prototype,"symbol",void 0),B([o()],O.prototype,"price",void 0),B([o()],O.prototype,"amount",void 0),B([t()],O.prototype,"visible",void 0),B([t()],O.prototype,"imageError",void 0),O=B([l("wui-token-list-item")],O);const z=e`
  :host {
    width: 100%;
  }
